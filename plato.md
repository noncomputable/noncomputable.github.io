...
I want to know the information adversity of an interface independent of how these properties are distributed among the messages we inject. If we model the relationship between different properties a message can have and the likelihood that users will see it, we can craft messages with properties to vary their likelihood of exposure.
